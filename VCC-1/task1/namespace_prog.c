...
int main() {
   ...
   // ------------------ WRITE CODE HERE ------------------
    ...
    if((child_pid = clone(child_function, child_stack + CHILD_STACK_SIZE,CLONE_NEWUTS|CLONE_NEWPID | SIGCHLD, pipefd))==-1)
        errExit("clone");
    ...
    */
    ...
    //Reference taken from the :::::  https://man7.org/linux/man-pages/man2/syscall.2.html
